...
2.	Изградете концептуална и логическа кадиаграма на избраната от вас платформа. Използвайки Visio (draw.io или подобен инструмент). Логическия модел трябва да садържа:
    1.	Минимум 6 таблици.
