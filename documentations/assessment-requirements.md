...
*  Оценка практика - представлява оценка от проект. За допускане до проект трябва да се изпълни до седма седмица домашната работа дадена повреме на лекции. Всеки получил положителна оценка от домашната работа се допуска до защита на проект. Проекта се ЗАЩИТАВА през последна седмица на упражнения. Проекта е ИНДИВИДУАЛЕН и се разработва самостоятелно.
